...
ChatLogic::ChatLogic()
{
    ...
    /*
    _chatBot = new ChatBot("/Users/karthi/Desktop/Udacity/CppND-Memory-Management-Chatbot/images/chatbot.png");
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    for (auto it = std::begin(_nodes); it != std::end(_nodes); ++it)
    {
      ...
      ChatBot chatBot("/Users/karthi/Desktop/Udacity/CppND-Memory-Management-Chatbot/images/chatbot.png");
